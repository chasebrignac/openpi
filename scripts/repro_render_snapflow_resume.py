#!/usr/bin/env python3
"""Render the next bounded SnapFlow checkpoint-ladder worker."""
...
TRANSITIONS = {(5_000, 10_000), (10_000, 20_000), (20_000, 30_000)}


class RenderError(ValueError):
    """Raised when exact source evidence cannot produce a SnapFlow resume worker."""
...
def render_snapflow_resume_spec(
    ...
    *,
    ...
    """Build and validate one exact direct-Python SnapFlow continuation."""
    ...
    if (source_step, target_step) not in TRANSITIONS:
        raise RenderError("SnapFlow continuation must follow 5k->10k->20k->30k")
...
def main() -> int:
    ...
    rendered = render_snapflow_resume_spec(
